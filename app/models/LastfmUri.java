...
/**
 * This class handles the creation of parameters for RESTful requests towards
 * the Last.fm API.
 *
 */
public class LastfmUri {
	...
	public final String API_KEY = "dbc6ad1a7ec3c2d8a6acba9c62cb8cf9";
	public final String API_SECRET = "9db4169bd589e8246a476a390867245f";
	...
	/**
	 * Returns the only existing LastfmUri instance. If it does not exist, it
	...
	/**
	 * Returns the whole parameter string that is necessary to request all
	 * events of a particular artist via the Last.fm API.
	 * 
	 * @param artist
	 *            - Name of an interpret or a band, e.g. 'Volbeat'.
	 * @param festivalsOnly
	 *            - <code>true</code> if only festivals shall be shown,
	 *            <code>false</code> if all events shall be retrieved.
	 ...
	 * 
	 * @param mbid
	 *            - A unique id for an interpret or band, e.g.
	 *            "bfcc6d75-a6a5-4bc6-8282-47aec8531818" for Cher.
	 * @param festivalsOnly
	 *            - <code>true</code> if only festivals shall be shown,
	 *            <code>false</code> if all events shall be retrieved.
	 * @return parameter string for requesting the Last.fm API.
	...
	/**
	 * Returns the whole parameter string that is necessary to request event
	 * information for an event ID.
	 * 
	 * @param id
	 *            - Event ID for a particular event, e.g. '123456'
	 * @return parameter string for requesting the Last.fm API
	 * @throws UnsupportedEncodingException
	 */
	...
	/**
	 * Returns the whole parameter string that is necessary to search a
	 * particular venue within Last.fm.
	 * 
	 * @param venue
	 *            - The venue's name, e.g. 'SAP Arena'
	 * @param country
	 *            - The venue's country, e.g. 'Germany'
	 * @return parameter string for requesting the Last.fm API
	 * @throws UnsupportedEncodingException
	 */
	...
	/**
	 * Returns the whole parameter string that is necessary to request all
	 * events for a particular venue.
	 * 
	 * @param id
	 *            - Venue ID for a particular venue, e.g. '654321'.
	 * @param festivalsOnly
	...
	/**
	 * Returns the whole parameter string that is necessary for requesting all
	 * events in the area of a particular location. If no location is handed
	 * over, the current position will be taken.
	 * 
	 * @param longitude
	 ...
	 *            - The longitude of a geo location.
	 * @param distance
	 *            - The radius to search within in kilometers, e.g. '10'.
	 * @param festivalsOnly
	 *            - <code>true</code> if only festivals shall be retrieved,
	 *            <code>false</code> if all event types shall be retrieved.
	 * @return parameter string for requesting the Last.fm API
	 * @throws UnsupportedEncodingException
	 */
	public String getGeoEvents(String latitude, String longitude, int distance, boolean festivalsOnly)
			throws UnsupportedEncodingException {
	...
	/**
	 * Returns a parameter string that is necessary to send RESTful requests via
	 * the Last.fm API.
	 * 
	 * @param methodParent
	 *            - e.g. 'location' or 'artist'
	 * @param method
	 *            - The used method, e.g. 'event.getInfo' or 'artist.getEvents'.
	 * @param search
	 *            - The term to search for, can be either a normal String or an
	 *            ID (depending on method), e.g. 'Volbeat' or '123456'
	 * @param festivalsOnly
	 *            - <code>true</code> if only festivals shall be retrieved,
	 *            <code>false</code> if all event types shall be retrieved.
	 * @return parameter string for requesting the Last.fm API
	 * @throws UnsupportedEncodingException
	 */
	public String lastfmURI(String methodParent, String method, String search, boolean festivalsOnly)
			throws UnsupportedEncodingException {
	...
	/**
	 * Returns whether the request response will be in XML format or in JSON
	 * format.
	 * 
	...
	/**
	 * Sets whether the request response shall be in XML format or in JSON
	 * format.
	 * 
	 * @param isJSON
	 *            - <code>true</code> if JSON format, <code>false</code> if XML
	 *            format.
	 */
