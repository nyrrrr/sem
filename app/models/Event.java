...
public class Event {
	 ...
	 *            - An event name.
	 * @param artists
	 *            - Artists that participate in this event.
	 */
	...
	public String toJSON(boolean includeVenue) {
		StringBuilder builder = new StringBuilder("{").append("\"id\": ")
				...
				.append(this.title != null ? "\"" + this.title + "\"" : null).append(", ").append("\"date\": ")
				.append(this.date != null ? "\"" + this.date + "\"" : null).append(", ").append("\"tickets\": ")
				.append(this.tickets != null ? "\"" + this.tickets + "\"" : null).append(", ").append("\"artists\": [");
